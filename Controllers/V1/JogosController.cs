using CatalogoDeJogosDotNet.Exceptions;
using CatalogoDeJogosDotNet.InputModel;
using CatalogoDeJogosDotNet.Services;
using CatalogoDeJogosDotNet.ViewModel;
...
namespace CatalogoDeJogosDotNet.Controllers.V1 {
    ...
    public class JogosController : ControllerBase    {
        ...
        [HttpPut("{idJogo:guid}")]
        public async Task<ActionResult> AtualizarJogo([FromRoute]
         Guid idJogo, [FromBody] JogoInputModel jogoInputModel)        {
            try            {
        ...
        public async Task<ActionResult> AtualizarJogo([FromRoute]
         Guid idJogo, [FromRoute] double preco)        {
            try            {
